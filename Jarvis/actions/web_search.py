...
TOOL = {
    "name": "web_search",
    "description": "Searches the web. Use for questions about current facts, events, prices, or topics. NEVER use this to close, quit, or find a program on the user's PC — that is close_application. NEVER open a browser just because they named a game.",
    "parameters": {
        "type": "OBJECT",
        "properties": {
            "query": {
